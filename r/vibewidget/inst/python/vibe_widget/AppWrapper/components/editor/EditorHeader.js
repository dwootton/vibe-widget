...
const headerClass = tw(
  "flex items-center justify-between gap-2 px-3 py-2 bg-[rgba(12,12,12,0.9)] border-b border-[rgba(242,240,233,0.12)] text-[12px] font-mono text-[#f2f0e9]"
);
...
const primaryButton = `${buttonBase} ${tw("bg-accent text-[#0b0b0b] border-none")}`;
const subtleButton = `${buttonBase} ${tw("bg-transparent border border-[rgba(242,240,233,0.18)] text-[#f2f0e9]")}`;
