...
class GenerationService:
    ...
    def __init__(
        ...
        *,
        ...
        # `fix_runtime_error` surface without making any network calls. Used
        # by `VIBE_PROVIDER=fake` in `core/widget.py` and by host/test code
        # that wants deterministic, offline generation.
