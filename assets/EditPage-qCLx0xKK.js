import{j as e}from"./index-Ag879TfP.js";import{D as a}from"./DocMdxPage-C1Xb4fjc.js";import"./DocContent-ClmzcaAj.js";const o={title:"Edit",description:"Change a generated widget with a follow-up prompt, in Python or in the widget itself."};function i(t){const n={a:"a",code:"code",h2:"h2",p:"p",pre:"pre",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:[e.jsx(n.code,{children:"widget.edit(...)"}),` describes a change in plain language and returns a new widget with that change
