const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Ag879TfP.js","assets/index-BMT_jPrw.css"])))=>i.map(i=>d[i]);
import{_ as p}from"./index-Ag879TfP.js";class f{constructor(){this.pyodide=null,this.loadPromise=null,this.state={ready:!1,loading:!1,error:null,loadProgress:0},this.stateListeners=new Set,this.widgetModels=new Map,this.widgetHandler=null}onStateChange(e){return this.stateListeners.add(e),e(this.state),()=>this.stateListeners.delete(e)}updateState(e){this.state={...this.state,...e},this.stateListeners.forEach(t=>t(this.state))}setWidgetHandler(e){this.widgetHandler=e}getWidgetModel(e){return this.widgetModels.has(e)||this.widgetModels.set(e,new w(e,this)),this.widgetModels.get(e)}notifyTraitChange(e,t,i){if(this.widgetModels.forEach((s,a)=>{a!==e&&s.notifyChange(t,i)}),this.pyodide)try{const s=JSON.stringify(i).replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/\n/g,"\\n");this.pyodide.runPythonAsync(`
import json
