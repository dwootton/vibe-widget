...
export const TimeDial = ({
  ...
  if (targetShop) {
    ...
    const endAng = minToAngle(returnMin);
...
export default function Widget({ model, React }) {
  ...
  const syncOutputs = (rKm, insideIndices, openIndices, lMin, bMin, dIdx, tIdx) => {
  ...
  // Update shop markers and outputs when dial/day/target changes
  React.useEffect(() => {
    updateMarkers();
  ...
  }, [leaveMin, backMin, day, targetIndex]);
